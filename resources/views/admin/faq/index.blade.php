		...
		<div class="page-content">
			<div class="row">
				<div class="col-12 col-lg-12 mx-auto">
					<h5 class="mb-0 text-uppercase">Faq<button type="button" class="btn btn-sm btn-outline-primary px-5 radius-30 float-end" data-bs-toggle="modal" data-bs-target="#Modal" onclick="chechdata()"><i class="bx bx-plus mr-1"></i>{{ __('common.add') }}</button></h5>
					<hr class="mt-4"/>
					<div class="card">
						<div class="card-body">
							<div class="table-responsive">
								<table id="dataTableBuilder" class="table table-striped table-bordered" style="width:100%">
									<thead>
										<tr>
											<th></th>
											<th><div class="col-sm-12 datatable-form-filter no-padding"><input type="text" class="form-control" name="filter_name" autocomplete="off" placeholder="Search By Questions"></div></th>
											<th></th>
											<th></th>
										</tr>
										<tr>
