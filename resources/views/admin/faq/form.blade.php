            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="ModalLabel"><span id="edit">Add</span> Blog</h5>
                    ...
                    <div class="modal-body">
                        <div class="row"><div class="col-md-12"><div id="response"></div></div></div>
                          <div class="form-group mt-3">
                            {!! Form::label('name', 'Question', ['class' =>  'form-label']) !!}<i class="text-danger"> *</i>
                            {!! Form::text('name','',['id'=>"name",'class'=>"form-control required"]) !!}
                          </div>
                          <div class="form-group mt-3">
                            {!! Form::label('desc', 'Answer', ['class' =>  'form-label']) !!}<i class="text-danger"> *</i>
                            {!! Form::textarea('desc',null,["class"=>"form-control required","id"=>"desc",'rows' => "3"]) !!}
                          </div>
