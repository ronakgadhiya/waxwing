		...
		<div class="page-content">
			<div class="row">
				<div class="col-12 col-lg-12 mx-auto">
					<h5 class="mb-0 text-uppercase">Product<button type="button" class="btn btn-sm btn-outline-primary px-5 radius-30 float-end" data-bs-toggle="modal" data-bs-target="#Modal" onclick="chechdata()"><i class="bx bx-plus mr-1"></i>{{ __('common.add') }}</button></h5>
					<hr class="mt-4"/>
					<div class="card">
						<div class="card-body">
								...
								<table id="dataTableBuilder" class="table table-striped table-bordered" style="width:100%">
									<thead>
										<tr>
											...
											<th><div class="col-sm-12 datatable-form-filter no-padding">{!! Form::select('filter_categorie',['' => 'Select Product Category']+$ProductCategory,null,['id' => 'filter_categorie','class' => 'form-select form-control']) !!}</div></th>
											<th></th>
											<th></th>
											<th></th>
										</tr>
										<tr>
											...
											<th>{{ __('common.productcategory') }}</th>
											<th>{{ __('common.img') }}</th>
...
<script type="text/javascript">
    ...
    var productcategory="{{ __('common.productcategory') }}";
	var img="{{ __('common.img') }}";
