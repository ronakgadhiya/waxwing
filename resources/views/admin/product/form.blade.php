		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
                    <h5 class="modal-title" id="ModalLabel"><span id="edit">Add</span> Product</h5>
				...
				<div class="modal-body">
					...
					<div class="form-group">
						{!! Form::label('product_id', 'Product Category', ['class' => 'form-label']) !!}
						{!! Form::select('product_id',['' => 'Select Product Category']+$ProductCategory,null,['id' => 'product_id','class' => 'form-select form-control required']) !!}
					  </div>

					  <div class="form-group mt-3">
						{!! Form::label('name', 'Title', ['class' =>  'form-label']) !!}<i class="text-danger"> *</i>
						{!! Form::text('name','',['id'=>"name",'class'=>'form-control required','required'=>true]) !!}
					  </div>
					  ...
					  <div class="form-group mt-3">
						{!! Form::label('measurement', 'measurement', ['class' =>  'form-label']) !!}
						{!! Form::textarea('measurement',null,["class"=>"form-control","id"=>"measurement"]) !!}
					  </div>
