			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						{!! Form::label('categorie_id', 'Blog Category', ['class' => 'form-label']) !!}
						{!! Form::select('categorie_id',['' => 'Select Blog Category']+$BlogCategory,null,['id' => 'categorie_id','class' => 'form-select form-control']) !!}
					  </div>
