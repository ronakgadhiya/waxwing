		...
		<div class="page-content">
			<div class="row">
				<div class="col-12 col-lg-12 mx-auto">
					<h5 class="mb-0 text-uppercase">Slider<button type="button" class="btn btn-sm btn-outline-primary px-5 radius-30 float-end" data-bs-toggle="modal" data-bs-target="#Modal" onclick="chechdata()"><i class="bx bx-plus mr-1"></i>{{ __('common.add') }}</button></h5>
					<hr class="mt-4"/>
					<div class="card">
						<div class="card-body">
