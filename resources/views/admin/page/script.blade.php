...
$(document).ready(function () {
  $('#Form').submit(function(e){
      ...
      var routeUrl = "{{route('page.store')}}";
      var routeMethod = "post";
      if($('#id').val() != '')
      {
          routeUrl = "/admin/page/"+$('#id').val()+"";
...
function actionedit(id) {
  $.get("pagebyid/"+id,function (data) {
    ...
    if(data[0].img != null){
      $(".image").html('<div style="position: relative;"><span class="spanremovebtn" onclick="deleteimage('+data[0].id+',\'page\',\'img\')" >X</span><img src="/uplods/page/'+data[0].img+'" class="img-fluid rounded" style="width: 100%;" ></div>');
    }
  });
} 
